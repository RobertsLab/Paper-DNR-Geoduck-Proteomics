...
# Sys.setenv("plotly_username"="yourusername") #Insert Plotly username
# Sys.setenv("plotly_api_key"="yourkey") #Insert Plotly API key
...
SRM.temp2.screened <- SRM.temp2[!grepl("3-C|42-C|53-B|53-D|70-C|73-B|104-B|104-D|127-B|128-A|55-A|114-A|114-D|57", SRM.temp2$X1),]
