...
# HSP70 <- data.melted.plus[grepl(c("HSP70"), data.melted.plus$Protein.Name),] #Poor Quality 
...
# P=0.38331 by Site, 0.84658 by Region
...
# P=0.92904 for Site, 0.68116 for Region
...
# P=0.70765 for Site, 0.34133 for Region
...
# P=0.70765 for Site, 0.49375 for Region
...
# Cannot use HSP70, only 1 peptide
...
# P=0.017491 for Site, 0.0024988 for Region
...
# Cannot use Peroxiredoxin, only 1 peptide 
...
#P=0.010995 for Site, 0.0014993 for Region
...
#P=0.47776 for Site, 0.092954 for Region
...
# Cannot use Rab.11B- only one peptide
...
#P=0.62919 for Site, 0.50275 for Region
...
#P=0.78661 for Site, 0.29435 for Region
...
# P=0.29435 for Site, 0.023988 for Region
Trifunctional.vegdist <- vegdist(Trifunctional.4anosim[,1:6], 'bray', na.rm=TRUE)
...
# # HSP 70 - Can't use this, only 1 good peptide
