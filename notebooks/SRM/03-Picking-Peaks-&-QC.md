...
### Files: 
  * [SRM Transitions](../../data/SRM/SRM-Transitions.csv)
  * [Predicted RT calculations](../../data/SRM/2017-07-18-Predicted-SRM-Retention-Times-LHS.xlsx)
  * [PRTC peptides skyline project file](../../data/DIA/DIA-PRTC-peptides.sky)
...
For the MS/MS run on Vantage we supplied a methods file [Vantage_nanoAcq_geoduckLS_60min_DrM27cm.meth](../../data/SRM/Vantage_nanoAcq_geoduckLS_60min_DrM27cm.meth) that indicated a set of peptides/transitions to measure for each protein we wanted to target. Not all the peptides that make up a protein were measured (that would require too much time, and is unnecessary); our standard was to measure 3 peptides per protein, and 3 transitions per peptide, thus 9 transitions per protein.  

When we created our Skyline project file in [Notebook 01](../../notebooks/SRM/01-Create-Skyline-Project.md) all proteins' peptides populated on the analyte tree/"Targets" pane.  Before analyzing our data, let's remove the unnecessary peptides:

Open the [SRM Transitions](../../data/SRM/SRM-Transitions.csv) and the SkylineDaily project.  In the Targets pane of the Skyline project, click on the + sign next to a protein to unfold all peptides.  You'll notice that a few peptides have a colored dot next to them (red, yellow, or green).  Those are likely the peptides you targeted.
...
![00](../../images/Picking-Peaks-00.PNG?raw=true)
![00a](../../images/Picking-Peaks-00a.PNG?raw=true)
![00b](../../images/Picking-Peaks-00b.PNG?raw=true)
...
![00c](../../images/Picking-Peaks-00c.PNG?raw=true)

The resulting analyte tree should look something like this: 
![00d](../../images/Picking-Peaks-00d.PNG?raw=true)
...
![00e](../../images/Picking-Peaks-00e.PNG?raw=true)
![00f](../../images/Picking-Peaks-00f.PNG?raw=true)

There will also be extraneous PRTC peptides, which you can delete. Your final analyte tree should look something like this: 

![00g](../../images/Picking-Peaks-00g.PNG?raw=true)
...
![1](../../images/Picking-Peaks-01.PNG?raw=true)
...
![4](../../images/Picking-Peaks-04.PNG?raw=true)
...
![5](../../Picking-Peaks-05.PNG?raw=true)
...
![11](../../images/Picking-Peaks-11.PNG?raw=true)
![12](../../images/Picking-Peaks-12.PNG?raw=true)

When no peaks are found I remove the peak from the data by right-clicking and selecting "remove peak":
![13](../../images/Picking-Peaks-13.PNG?raw=true)
...
![09](../../images/Picking-Peaks-09.PNG?raw=true)
![10](../../images/Picking-Peaks-10.PNG?raw=true)
...
![17](../../images/Picking-Peaks-17.PNG?raw=true)
...
![19](../../images/Picking-Peaks-19.PNG?raw=true)
![16](../../images/Picking-Peaks-16.PNG?raw=true)
...
![20](../../images/Picking-Peaks-20.PNG?raw=true)
...
Example of a poor-quality peptide, which is missing from several replicates, is THGAPTDEER in Superoxide Dismutase: 
  ![05b](../../images/Picking-Peaks-05b.PNG?raw=true)
...
![05c](../../images/Picking-Peaks-05c.PNG?raw=true)

This is compared to a more regular signal for replicate # 292 for the same peptide:
![05d](../../images/Picking-Peaks-05d.PNG?raw=true)
...
![14](../../images/Picking-Peaks-14.PNG?raw=true)
![15](../../images/Picking-Peaks-15.PNG?raw=true)
...
## Total actions performed on my SRM data in Skyline:
  ...
  * Exported report: [2017-Geoduck-SRM-Skyline-Report.csv](../../data/SRM/2017-Geoduck-SRM-Skyline-Report.csv)
